...
INSERT INTO public.properties VALUES (9, 'nometal', 18.998, -220, -188.1, 1);
INSERT INTO public.properties VALUES (10, 'nometal', 20.18, -248.6, -246.1, 1);
...
--
-- Name: elements name_ukey; Type: CONSTRAINT; Schema: public; Owner: freecodecamp
--
...
--
-- Name: elements symbol_ukey; Type: CONSTRAINT; Schema: public; Owner: freecodecamp
--

ALTER TABLE ONLY public.elements
    ADD CONSTRAINT symbol_ukey UNIQUE (symbol);
